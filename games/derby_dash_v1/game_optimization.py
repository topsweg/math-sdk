...
class OptimizationSetup:
    def __init__(self, game_config):
        ...
        self.game_config.opt_params={
            "base":{
                "conditions":{
                    "freegame":ConstructConditions(rtp=0.342,hr=280,search_conditions={"symbol":"scatter"}).return_dict(),
                    "basegame":ConstructConditions(rtp=0.618).return_dict(),
                },
                "scaling":{},
            ...
            "bonus":{
                "conditions":{"freegame":ConstructConditions(rtp=0.96,hr="x").return_dict()},
                "scaling":{},
